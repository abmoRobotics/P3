...
namespace dynamixel {
    ...
    public:
        ...
        : port_handler(new ::dynamixel::PortHandler(pin_rts_enable))
        , packet_handler((ver == ProtocolVersion::V2) ? (::dynamixel::PacketHandler*) new ::dynamixel::Protocol2PacketHandler() : (::dynamixel::PacketHandler*) new ::dynamixel::Protocol1PacketHandler())
#if 0
